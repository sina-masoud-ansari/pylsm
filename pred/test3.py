...
if __name__ == "__main__":
    ...
    x = scipy.arange(0, training_sample_length).reshape(training_sample_length, 1)
    signal_A = scipy.sin(0.01 * x)
    signal_B = scipy.sin(0.05 * x)
    signal_C = scipy.sin(0.03 * x)
    train_signals = [[signal_A], [signal_B]]
    test_signals = [[signal_C]]
